...
SRSLTE_API int srslte_dci_msg_get_type_all(srslte_dci_msg_t *msg,
                                       srslte_dci_msg_type_t *type,
                                       uint32_t nof_prb,
                                       uint16_t msg_rnti);

SRSLTE_API int srslte_dci_msg_unpack_pdsch_all(srslte_dci_msg_t *msg,
                                           srslte_ra_dl_dci_t *data,
                                           uint32_t nof_prb,
                                           bool crc_is_crnti);

SRSLTE_API uint32_t srslte_dci_format_all_sizeof_lut(srslte_dci_format_t format,
                                                 uint32_t nof_prb);
